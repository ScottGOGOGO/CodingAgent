    ...
    <div className="studio-shell">
      ...
      <section className="preview-column">
        ...
        <div className="preview-stage">
          <div className="phone-preview-rig">
            <div className="phone-device" aria-label="Mobile app preview">
              <div className="phone-bezel">
                ...
                <div className="preview-frame-shell">
                  {previewUrl ? <iframe data-testid="preview-frame" title="Generated mobile preview" src={previewUrl} /> : null}
            ...
            <div className="phone-preview-meta" aria-hidden="true">
              <span>390</span>
              <span>×</span>
              <span>844</span>
            </div>
